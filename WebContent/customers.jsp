<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import="com.bank.model.*, javax.servlet.ServletException, java.sql.ResultSet" %> 
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                            ...
                            <div class="sidepanel-wrapper">
                                ...
                                <div class="sidepanel-nav">
                                    ...
                                    <ul>
                                        ...
                                        <li class="active"><a href="Admin/customers.jsp">
                            ...
                            <div class="col-md-12">
                                <div class="transactions">                         
                                    <table>
                                        ...
                                        <%ResultSet rs = (ResultSet)request.getAttribute("search");
    										while(rs.next()){
